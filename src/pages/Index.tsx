    ...
    <div className="flex min-h-screen font-dm-sans">
            ...
            <div className="flex items-end justify-between gap-2 h-20">
              {weekData.map((val, i) => (
                <div key={i} className="flex flex-col items-center gap-1 flex-1">
                  <div
                    className="w-full bg-pacific/80 rounded-t-md transition-all"
                    style={{ height: `${val}%` }}
                  />
      ...
      <div className="w-full lg:w-[45%] bg-ocean-dark flex items-center justify-center p-8">
        <div className="w-full max-w-sm flex flex-col items-center gap-8">
          ...
          {/* Subtitle */}
          <p className="text-ocean-muted text-base animate-stagger-2">
            Preveja. Compita. Vença.
          </p>

          {/* Google Button */}
          <button className="animate-stagger-3 w-full flex items-center justify-center gap-3 bg-ocean-button border border-pacific rounded-[12px] px-6 py-4 text-foreground font-medium transition-all duration-200 hover:bg-pacific hover:text-ocean-dark">
